    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (result) {
                ...
                category_infoDiv.innerHTML =
                    '<b id="uploadText" style="color:white;">UPLOAD A PHOTO</b>' +
                ...
                category_infoDiv.innerHTML =
                    '<p id="loginAlert" style="text-align: center; color: #fff;"> Must be signed in to upload! </p>';
            }
        }
    };
}
            ...
            storageRef
                ...
                .catch((error) => {
                    ...
                    uploadMessage.innerHTML =
                        uploadMessage.innerHTML +
                        '<p style="color: red;"> Upload Unsuccessful </p>';
                });
        } else {
